...
const dropStageSchema = z.object({
  id: z.string().optional(),
  reps: z.coerce.number().int("Whole reps only").min(1, "").max(100, "Reps must be between 1 and 100"),
  unit: z.enum(["kg", "bw", "time", "km"]).optional(),
  value: z.string().min(1, "").max(20, "Max 20 chars"),
});
    ...
    z.object({
      ...
      sets: z.array(
        z.object({
          ...
          dropStages: z.array(dropStageSchema).optional(),
